...
<div class="row">
    <div class="col-xs-12 col-md-12 col-lg-12 ">
        <div class="btn-group">
            ...
            <?php echo anchor('admin/post/form/', 'Create New Post <i class="fa fa-plus-circle"></i>', array('class'=>'btn btn-default small'))?>
        </div>
        <br>
        <br>
        <div class="table-responsive">
            ...
            <?php else: ?>
                    <tr>
                        <td colspan="4">We could not find any posts</td>
                    </tr>
            <?php endif; ?>
                </tbody>
            </table>
