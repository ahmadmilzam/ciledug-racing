...
class Ion_auth_model extends CI_Model
{
    ...
    public function __construct()
    {
        ...
        if ($this->hash_method == 'bcrypt') {
            ...
            $this->load->library('user/bcrypt',$rounds);
        }
     ...
     * @add first_name, last_name fields in select query
     **/
    public function login($identity, $password, $remember=FALSE)
    {
        ...
        $query = $this->db->select($this->identity_column . ', username, first_name, last_name, id, created_on, active, last_login')
    ...
    public function get_all_users_with_group()
    {
        ...
        // return $users;
        return $this->_reformat_array_users_with_group($users);
    }
    ...
    **/
     ...
     * @author jrmadsen67
     * modified by: Ahmad Milzam
     * add: first name and last name to session
     **/
    ...
    **/
    ...
    /**
     * format result join query table users, groups and users_groups
     * @param  [array] $users_array
     * @return [array]
     * @author Ahmad Milzam http://ahmadmilzam.com
     */
    protected function _reformat_array_users_with_group($users_array)
    {
        $data = array();
        foreach ($users_array as $key => $value) {
            $data[ $value['id'] ]['id']         = $value['id'];
            $data[ $value['id'] ]['username']   = $value['username'];
            $data[ $value['id'] ]['ip_address'] = $value['ip_address'];
