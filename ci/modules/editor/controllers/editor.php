...
class Editor extends MY_Controller {
    ...
    const IMAGE_UPLOAD_DIR = 'media/images';
    ...
    {
        $this->load->view('view_ckeditor',array(
            'ckeditor' => $this->_setup_ckeditor('ckeditor'),
            'content_html' => $data // your model property's HTML for CKEditor textarea
        ));
    }
    ...
    private function _setup_ckeditor($id)
    {
        ...
        $ckeditor = array(
            'id' => $id,
            'path' => 'assets/lib/ckeditor',
            'config' => array(
                'toolbar' => 'Basic',
                'filebrowserImageUploadUrl' => '/ckeditor/upload',
                'extraPlugins' => 'imagebrowser',
                'imageBrowser_listUrl' => '/media/get_files'
            )
        );
...
/* Location: .//F/Server/htdocs/ciledug-racing/ci/modules/media/controllers/ckeditor.php */